...
Attributes:
    devicePath (`str <https://docs.python.org/2/library/stdtypes.html>`_):
       ...
       The device path of the SSD disk.See `devicePath <vim/host/ScsiDisk.rst#devicePath>`_ 
    partition (`vim.host.DiskPartitionInfo.Specification <vim/host/DiskPartitionInfo/Specification.rst>`_, optional):
