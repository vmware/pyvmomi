...
Attributes:
    ipAddress ([`vim.net.IpConfigInfo.IpAddress <vim/net/IpConfigInfo/IpAddress.rst>`_], optional):

       Zero, one or more manual (static) assigned IP addresses to be configured on a given interface.
    dhcp (`vim.net.DhcpConfigInfo <vim/net/DhcpConfigInfo.rst>`_, optional):
